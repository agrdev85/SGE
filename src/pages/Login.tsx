        ...
        <div className="w-full max-w-md animate-slide-up">
          <div className="flex items-center gap-3 mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-300">Gestión de Eventos</p>
            </div>
          </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" type="email" placeholder="tu@email.com" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-10 border-gray-300 focus:border-green-500 focus:ring-green-500" required />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" type="password" placeholder="••••••••" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 border-gray-300 focus:border-green-500 focus:ring-green-500" required />
                  </div>
                </div>
                <Button type="submit" className="w-full text-white font-bold hover:opacity-90 transition-opacity" style={{ background: '#1e40af' }} disabled={isLoading}>
                  {isLoading ? <Loader2 className="h-4 w-4 animate-spin" /> : <>Iniciar Sesión <ArrowRight className="h-4 w-4" /></>}
                </Button>
              </form>
              <div className="mt-6">
                <p className="text-center text-sm text-gray-600">
                  ¿No tienes cuenta?{' '}
                  <Link to="/register" className="font-medium hover:underline" style={{ color: '#1e40af' }}>Regístrate</Link>
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12">
        <div className="max-w-lg text-center text-white animate-fade-in">
          <div className="mb-8">
            ...
            <h2 className="text-4xl font-display font-bold mb-4">Gestiona tus eventos de forma eficiente</h2>
            <div className="h-1 w-32 bg-green-500 mx-auto mb-6"></div>
          </div>
          <p className="text-lg opacity-90 mb-8">
            Plataforma integral para la gestión de congresos, conferencias y eventos.
